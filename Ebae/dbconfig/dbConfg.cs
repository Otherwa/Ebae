...
namespace Ebae.dbconfig
{
    public class DbConfg
    {
        ...
        {
            string connectionStringWithDatabase = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Ebae\Ebae\dbconfig\Ebae.mdf;Integrated Security=True;Connect Timeout=30";
